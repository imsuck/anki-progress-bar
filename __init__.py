...
def update_overlay():
    ...
    if mw.state != "review":
        mw.reviewer.web.eval("let c = document.getElementById('anki-timer-overlay'); if(c) c.innerHTML = '';")
        return
    ...
    if total_remaining == 0:
        ...
        historical_weighted = (new_c * avg_new + learn_c * avg_learn + review_c * avg_review) / total_remaining
